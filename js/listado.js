...
Listado.prototype.obtenerUbicaciones = function() {
    ...
    */
    ...
    var ubicaciones = this.restaurantes.map(restaurante => restaurante.ubicacion);
    //Se crea un nuevo array donde se van a agregar las ciudades pero sin repetirse
    var ubicacionesSinRepetidos = eliminarRepetidosDeArray(ubicaciones);
    return ubicacionesSinRepetidos.sort();
}
...
Listado.prototype.obtenerRubros = function() {
    ...
    var rubrosSinRepetidos = eliminarRepetidosDeArray(rubros);
    return rubrosSinRepetidos.sort()
}
...
Listado.prototype.obtenerHorarios = function() {
    ...
    var horarios = [];
    arregloDeHorarios.forEach(arreglo => arreglo.forEach(horario => horarios.push(horario)));
    //En este arreglo vamos a poner todos los horarios pero sin repetidos
    var horariosSinRepetidos = eliminarRepetidosDeArray(horarios);
...
function eliminarRepetidosDeArray(array) {
